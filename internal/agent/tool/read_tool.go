...
func (t *ReadTool) ExecutionMode() core.ToolExecutionMode {
...
func (t *ReadTool) Execute(ctx context.Context, id string, args json.RawMessage, onUpdate core.ToolUpdateFunc) (core.AgentToolResult, error) {
	...
	return core.AgentToolResult{Content: core.ContentList{core.NewTextContent(text)}}, nil
}
