...
func (t *EditTool) ExecutionMode() core.ToolExecutionMode {
...
func (t *EditTool) Execute(ctx context.Context, id string, args json.RawMessage, onUpdate core.ToolUpdateFunc) (core.AgentToolResult, error) {
