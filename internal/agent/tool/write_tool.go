...
func (t *WriteTool) ExecutionMode() core.ToolExecutionMode {
...
func (t *WriteTool) Execute(ctx context.Context, id string, args json.RawMessage, onUpdate core.ToolUpdateFunc) (core.AgentToolResult, error) {
