...
func runSearch(t *testing.T, tool core.AgentTool, args map[string]any) core.AgentToolResult {
	t.Helper()
...
func TestSearchToolModes(t *testing.T) {
	for _, tool := range []core.AgentTool{&GrepTool{}, &FindTool{}, &LsTool{}} {
		if tool.ExecutionMode() != core.ToolExecutionParallel {
