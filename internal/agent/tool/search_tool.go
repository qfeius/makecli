...
func (t *GrepTool) ExecutionMode() core.ToolExecutionMode {
...
func (t *GrepTool) Execute(ctx context.Context, id string, args json.RawMessage, onUpdate core.ToolUpdateFunc) (core.AgentToolResult, error) {
...
func (t *FindTool) ExecutionMode() core.ToolExecutionMode {
	return core.ToolExecutionParallel
}
...
func (t *FindTool) Execute(ctx context.Context, id string, args json.RawMessage, onUpdate core.ToolUpdateFunc) (core.AgentToolResult, error) {
...
func (t *LsTool) ExecutionMode() core.ToolExecutionMode { return core.ToolExecutionParallel }
...
func (t *LsTool) Execute(ctx context.Context, id string, args json.RawMessage, onUpdate core.ToolUpdateFunc) (core.AgentToolResult, error) {
	...
	sort.Strings(dirs)
	sort.Strings(files)
	lines := slices.Concat(dirs, files)
