...
func (s stubTool) ExecutionMode() core.ToolExecutionMode { return core.ToolExecutionParallel }
func (s stubTool) Execute(ctx context.Context, id string, args json.RawMessage, onUpdate core.ToolUpdateFunc) (core.AgentToolResult, error) {
	return core.AgentToolResult{Content: core.ContentList{core.NewTextContent("ok")}}, nil
}
