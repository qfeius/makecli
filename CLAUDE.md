...
cmd/            - Cobra 子命令层（root、version、configure[token/config/set/get/verify]、app[create/list/init/delete/deploy]、entity、relation、record、apply、diff、update、schema、integration[ocr]）
